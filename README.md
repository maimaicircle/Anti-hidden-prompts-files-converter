...
If you are not sure whether it is the problem with the tk or smth else you can run the test.tk.py to check if you can get the text.

Remember to install latest python version to get the correct tk:

https://www.python.org/downloads/

If there is a problem on mac tk please refer to IF_WHITE_SCREEN_ON_MAC.txt
